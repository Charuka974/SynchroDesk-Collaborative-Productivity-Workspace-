...
export default function Sidebar({ isCollapsed, onCollapseToggle }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside className={`fixed left-0 top-0 h-full bg-white border-r-2 border-gray-400 p-6 hidden lg:block transition-all duration-300 z-50 ${isCollapsed ? 'w-20' : 'w-64'}`}>
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <button
            ...
            <svg
                ...
                >
                {isCollapsed ? (
                    // Right-pointing chevron for expanding
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                ) : (
                    // Left-pointing chevron for collapsing
        ...
        <nav className="space-y-2">
          <button 
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 text-gray-600 hover:bg-gray-50 cursor-pointer rounded-lg font-medium transition ${isCollapsed ? 'justify-center' : ''}`}
          ...
          >
            ...
            {!isCollapsed && <span className="whitespace-nowrap">Tasks</span>}
          </button>
          ...
          >
            <svg className="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 8h10M7 12h6m-6 4h8M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H7L5 4v16z"/>
            </svg>
          ...
          >
            ...
            {!isCollapsed && <span className="whitespace-nowrap">User Profile</span>}
          </button>
      ...
      {/* Mobile Sidebar */}
      <aside className={`fixed left-0 top-0 h-full bg-white border-r border-gray-200 p-6 lg:hidden transition-all duration-300 z-50 ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} w-64`}>
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold text-gray-900 whitespace-nowrap">SynchroDesk</h1>
          </div>
          
          <button
            onClick={() => setIsMobileMenuOpen(false)}
            className="p-2 hover:bg-gray-100 rounded-lg transition shadow-md border border-gray-200"
          >
      ...
      <button 
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-3 bg-white rounded-lg shadow-lg border border-gray-200 hover:bg-gray-50 transition"
      >
        <svg className="w-6 h-6 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">

...
export const TaskPanel: React.FC<TaskPanelProps> = ({
  ...
  const addComment = async (task: ITask) => {
    ...
    const updated = [
      ...(task.comments || []),
      { userId: user._id, message: text, createdAt: new Date() },
    ];
                ...
                <div className="mt-3 bg-white p-3 rounded border border-gray-300 shadow-sm">
                  ...
                  {(task.comments || []).map((c, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="bg-gray-50 p-2 border border-gray-300 shadow-sm rounded mb-2"
                      >
                        {editing ? (
                          <>
                            <textarea
              ...
              <button
                ...
                className={`flex-1 p-3 font-bold rounded ${
                  ...
                  taskErrors.dueDate
                    ...
                    : "bg-linear-to-r from-slate-700 via-slate-800 to-slate-900 text-white"
                }`}
              >
                Add Task
              </button>
